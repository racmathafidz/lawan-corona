            ...
            <section className="container mx-auto mt-20">
                <div className="mx-5 sm:mx-10 lg:mx-20 xl:mx-0">
                    ...
                    <p className="text-xl text-gray-400 font-light text-justify sm:text-center xl:mx-36">
                        Orang yang terpapar virus corona akan mengalami gejala ringan hingga parah.<br/>
                        Rata-rata gejala akan muncul 5–14 hari setelah seseorang pertama kali terinfeksi virus ini.<br/>
                        Gejala antara lain :
                    </p>
                </div>
                    ...
                    <div>
...

                        {
                            data[0].ringan.map( item => {
                                return (
                                    <ul className="text-gray-400 text-xl font-light">
